        ...
        return (
            <div style={{ position: "relative", top: "1rem", margin: "auto", width: "90%" }}>
                ...
                <div className="flex" style={{ marginBottom: "2rem", position: "relative", top: "7rem" }}>
                    ...
                    <div className="container-fluid d-flex" style={{ display: "grid", gridGap: "2rem", position: "relative", top: "0rem", margin: "0rem", justifyContent: "space-between", padding: "0" }}>
                ...
                <p className="font-weight-bold text-left margin-left: 1rem" style={{ position: "relative", top: "1rem", fontSize: "1.7rem" }}>My Courses</p>
                    <div className="row">
